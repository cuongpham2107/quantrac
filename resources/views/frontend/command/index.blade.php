        ...
        <div class="container-fluid">
            <div class="border-bottom pt-6">
                <div class="row align-items-center">
                    <div class="col-sm col-12"><h1 class="h2 ls-tight">Lệnh điều khiển</h1></div>
                ...
                <ul class="nav nav-tabs overflow-x border-0">
                    <li class="nav-item"><a href="#" class="nav-link active">Tất cả lệnh điều khiển</a></li>
                    <li class="nav-item">
            ...
            <div class="vstack gap-4">
                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex align-items-center">
                        <h5 class="me-auto">Tất cả lệnh điều khiển</h5>
                    </div>
                </div>
                    ...
                    <table class="table table-hover table-nowrap">
                        ...
                        @foreach($command as $key=>$val)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{route('command.edit', $val->id)}}" class="btn btn-sm btn-square btn-neutral">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{route('command.destroy', $val->id)}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
                ...
                <div >
                    {{ $command->links('frontend.layout.pagination') }}
                </div>
