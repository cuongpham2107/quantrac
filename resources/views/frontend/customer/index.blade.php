        ...
        <div class="container-fluid">
            <div class="border-bottom pt-6">
                <div class="row align-items-center">
                    <div class="col-sm col-12"><h1 class="h2 ls-tight">Tài khoản</h1></div>
                    <div class="col-sm-auto col-12 mt-4 mt-sm-0">
                        <div class="hstack gap-2 justify-content-sm-end">
                            ...
                            <a href="{{route('customer.create')}}" class="btn btn-sm btn-primary" >
                                ...
                                <span>Tạo tài khoản cho khách hàng</span>
                            </a>
                        </div>
                    </div>
                </div>
                <ul class="nav nav-tabs overflow-x border-0">
                    <li class="nav-item"><a href="#" class="nav-link active">Tất cả khách hàng</a></li>
                    <li class="nav-item">
            ...
            <div class="vstack gap-4">
                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex align-items-center">
                        <h5 class="me-auto">Tất cả tài khoản</h5>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap">
                            ...
                            <tbody>
                                ...
                                <td>
                                    @if($val->quyen == 'admin')
                                        <span class="badge text-uppercase bg-soft-primary text-primary rounded-pill">Amin</span>
                                    @else
                                        <span class="badge text-uppercase bg-soft-primary text-primary rounded-pill">Người dùng</span>
                                    @endif
                                </td>
                                <td>
                                    @if($val->status == 'on')
                                ...
                                <td class="text-end">
                                    <a href="{{route('customer.edit', $val->id)}}" class="btn btn-sm btn-square btn-neutral">
                    ...
                    <div >
                        {{ $customer->links('frontend.layout.pagination') }}
                    </div>
