        ...
        <div class="container-fluid">
            <div class="border-bottom pt-6">
                <div class="row align-items-center">
                    <div class="col-sm col-12"><h1 class="h2 ls-tight">Log</h1></div>
                ...
                <ul class="nav nav-tabs overflow-x border-0">
                    <li class="nav-item"><a href="#" class="nav-link active">Tất cả log</a></li>
                    <li class="nav-item">
            ...
            <div class="vstack gap-4">
                ...
                <div class="card">
                    <div class="card-header border-bottom d-flex align-items-center">
                        <h5 class="me-auto">Tất cả log</h5>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover table-nowrap">
                        ...
                        @foreach($log as $key=>$val)
                            <tr>
                                <td>{{$key+1}}</td>
                                <td><a class="text-heading text-primary-hover font-semibold" href="#">{{$val->user_id}}</a></td>
                ...
                <div >
                    {{ $log->links('frontend.layout.pagination') }}
                </div>
